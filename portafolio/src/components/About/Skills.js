...
export default function Skills() {
    ...
    { name: "React JS", descripcion: "Conocimientos sobre el uso,creación y impliementación de la libreria React JS para sitios web estaticos y dinamicos,asi como de sus funciones como props y componentes(Este portafolio fue realizado con ReactJS)", icono: <FaReact className="iconsSkills" /> ,tipo : "Libreria"},
    { name: "Ubuntu", descripcion: "Experiencia en el uso del SO Ubuntu, conocimientos sobre comandos basicos de terminal", icono: <FaUbuntu className="iconsSkills" /> ,tipo : "Sistema Operativo"},
