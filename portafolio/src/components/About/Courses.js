...
export default function Courses() {
    const data = [
    { img: backEnd, titulo: "Desarrollador Back-end", descripcion: "Curso de capacitación para Desarrollador Back-end , dicho curso consto de la arquitectura cliente-servidor, modelo vista controlador, diferencias entre web estática y dinámica" },
